...
class _ModulContent {
  ...
  _ModulContent({required this.id, required this.title, required this.headerTitle, required this.description, required this.sections});
}
    ...
    switch (id) {
      ...
      case '3':
        return _ModulContent(
          ...
          headerTitle: 'MODUL 3: KALKULATOR DAMPAK LINGKUNGAN\n(THE "REAL IMPACT")',
          description: 'Modul ini menjelaskan dampak nyata dari pemilahan sampah organik dan anorganik melalui kalkulasi sederhana. Dengan menggunakan aplikasi kalkulator dampak, kita bisa melihat berapa banyak pohon yang dapat diselamatkan dan berapa banyak gas metana yang tidak dilepaskan ke atmosfer.',
          sections: [
            {
              'title': '10 Kg Kertas = 1 Pohon Bernnyawa',
              'content': 'Fakta Industri: Industri kertas merupakan industri kertas baru dihasilkan sekitar 10 pohon potongan setiap tahun. Perhitungan pohon yang hilang dalam mengeluarkan satu liter susu untuk merawat habitat salwa har.\n\nDampak Asumsi: Dengan melakukan pemilahan sampah kertas di masyarakat, kita memberikan pilihan untuk industri pengolahan untuk melakukan daur ulang terhadap pulp serat. Pohon yang akan dimulai dengan tidak akan mengalami deforestasi dari manusia sejawat tahun.',
            },
            {
              'title': 'Menahan Ledakan Gas Metana di TPA',
              'content': 'Proses Kimawi di TPA: Saat sampah organik (makanan) dibuang tercampur dengan sampah lainnya, pemecahan sampah akan menghasilkan gas metan melalui proses anaerobik. Sampah organik akan mengalami dekomposisi anaerob, (tanda oksigen/dasar tunggannya) dapat bisa menciptakan gas metana.\n\nBahaya Gas Metana (CH₄): Gas metana adalah umum kaca berbahaya yang memiliki 28-34 kali lebih berbahaya dibanding karbon dioksida (CO₂). Demiikinya, mengembalikan pengguna di dalam wadah plastik kecil yang mendadaknginkan gas karbon organik Sampel Permanasan Akhir (TPA).\n\nDampak Akumuli: Dengan memisahkan sampah organik dan menyertakan sampah organik secara benar ke lokasi, kami memotong emisi gas metana berbahaya di lingkungan sumber umban sunbernya. Kamu menjadi bagian dari agen pejaga emisi.',
            },
          ],
        );
      default:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('EcoBook', style: _jakarta(fontSize: 16, fontWeight: FontWeight.w700)),
        centerTitle: true,
      ),
      body: SafeArea(
        bottom: false,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text(content.headerTitle, textAlign: TextAlign.center, style: _jakarta(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
              ...
              Container(
                ...
                child: Text(content.description, style: _jakarta(fontSize: 12, color: Colors.white, height: 1.6)),
              ),
              const SizedBox(height: 16),
              Text(section['title']!, style: _jakarta(fontSize: 14, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text(section['content']!, style: _jakarta(fontSize: 12, color: Colors.black87, height: 1.6)),
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: idx == _currentSection ? const Color(0xFF4CAF50) : const Color(0xFFBDBDBD),
                      ),
                    ),
                  );
                }),
                  ...
                  if (_currentSection > 0)
                    Expanded(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF9E9E9E), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
                        child: Text('Sebelumnya', style: _jakarta(color: Colors.white)),
                      ),
                    ),
                  ...
                  if (_currentSection < content.sections.length - 1)
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Text('Selanjutnya', style: _jakarta(color: Colors.white)),
                      ),
                    ),
                ],
              ),
