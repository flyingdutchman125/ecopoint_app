          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: done ? const Color(0xFF4C8C2B) : const Color(0xFFBDBDBD),
                shape: BoxShape.circle,
              ),
            ),
            const SizedBox(height: 6),
            if (!done)
              Container(width: 2, height: 30, color: const Color(0xFFBDBDBD))
            else
              Container(width: 2, height: 30, color: const Color(0xFF4C8C2B)),
          ],
        ),
                      ...
                      children: [
                        ...
                        Icon(
                          completed
                              ...
                              : Icons.expand_more,
                          color: completed ? Colors.green : Colors.black38,
                        ),
                      ],
                    ),
                  ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Icon(Icons.map, size: 48, color: Colors.black26),
                      ),
                    ),
                    const SizedBox(height: 12),
                    Text(
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'Orderan Telah selesai jangan lupa memberi rating & Ulasan',
                      style: _jakarta(fontSize: 12, color: Colors.black54),
                    ),
                  ],
                ),
                      ...
                      onPressed: () async {
                        final confirm = await showDialog<bool>(
                          ...
                          builder: (ctx) => AlertDialog(
                            title: Text(
                              'Selesaikan Order',
                              style: _jakarta(fontWeight: FontWeight.w700),
                            ),
                            content: Text(
                              'Konfirmasi order ini telah selesai ?',
                              style: _jakarta(),
                            ),
                            actions: [
                              TextButton(
                                ...
                                child: Text(
                                  'Batal',
                                  style: _jakarta(color: Colors.black54),
                                ),
                              ),
                              ElevatedButton(
                        ...
                        if (confirm == true) {
                          ...
                          context.push(
                            '/orders',
                            extra: {'updateOrder': updatedOrder},
                          );
                    ...
                    context.push(
                      ...
                      extra: {
                        ...
                        'item': {
                          'id': id,
                          'orderId': id,
                          'name': 'Hendra Pengepul (Pengepul Sukorejo)',
                          'detail': 'Penjemputan Daur Ulang',
                          'orderCode': id,
                        },
                      },
                    );
