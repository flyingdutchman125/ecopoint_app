...
class _WithdrawVerifyPageState extends State<WithdrawVerifyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final transactionId = 'WD${DateTime.now().millisecondsSinceEpoch.toString().substring(5)}';
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _detailRow('Metode Transfer', 'DANA (${wallet.bankAccount['phone']})'),
                      const SizedBox(height: 12),
                      _detailRow('Penerima', wallet.bankAccount['name'] as String? ?? 'Ahmad Syifa\'ul'),
                    ],
                  ),
