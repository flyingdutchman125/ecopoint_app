                      ...
                      children: [
                        ...
                        ListenableBuilder(
                          ...
                          builder: (context, _) {
                            ...
                            final ptsStr = pts.toString().replaceAllMapped(
                              RegExp(r'(\d)(?=(\d{3})+(?!\d))'),
                              (m) => '${m[1]}.',
                            );
                            final convStr = converted
                                .toString()
                                .replaceAllMapped(
                                  RegExp(r'(\d)(?=(\d{3})+(?!\d))'),
                                  (m) => '${m[1]}.',
                        ...
                        return Column(
                          children: conversionOptions.map((opt) {
                            ...
                            final hasEnoughPoints =
                                wallet.points.value >= pointsNeeded;
                                ...
                                onTap: () {
                                  if (isLocked) {
                                    ...
                                    if (balanceVal == 5000) {
                                      ...
                                      if (logDays < 7) {
                                        reason =
                                            'Nominal ini terkunci. Anda harus login selama 7 hari (saat ini $logDays/7) untuk membukanya.';
                                      } else {
                                        reason =
                                            'Batas penarikan mingguan untuk nominal ini sudah habis (0/1).';
                                      }
